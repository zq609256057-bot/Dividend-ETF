(function(root){
  ...
  root.DividendHistoryProduction={api:api,mapPayload:mapPayload,load:load,renderPine:renderHistoricalPine,DEFAULT_LABEL:DEFAULT_LABEL,LOADING_LABEL:LOADING_LABEL,get current(){return current;},get currentRequestId(){return currentRequestId;}};
  root.DividendHistoryShadow=root.DividendHistoryProduction;
